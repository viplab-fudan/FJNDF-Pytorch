...
from pyjnd.data import build_dataloader, build_dataset
from pyjnd.data.data_sampler import EnlargedSampler
from pyjnd.data.prefetch_dataloader import CPUPrefetcher, CUDAPrefetcher
from pyjnd.archs import build_model
from pyjnd.utils import (AvgTimer, MessageLogger, check_resume, get_env_info, get_root_logger, get_time_str,
                           init_tb_logger, init_wandb_logger, make_exp_dirs, mkdir_and_rename, scandir, load_file_from_url)
from pyjnd.utils.options import copy_opt_file, dict2str, parse_options
from pyjnd.utils.dist_util import master_only
...
def train_pipeline(root_path, opt=None, args=None):
    ...
    logger = get_root_logger(logger_name='pyjnd', log_level=logging.INFO, log_file=log_file)
