...
## 📖 Overview
This project provides a Frequency-Domain JND-Guided (Just Noticeable Difference) Pre-Filter Benchmark to evaluate the performance of various combinations of frequency-domain JND modeling and injection algorithms in the pre-processing stage of image and video compression.


<p align="center">
  <img src="assets/benchmark_arch.svg" width="900">
</p>

The architecture of our FJNDF-Pytorch framework is illustrated in the figure above. It is composed of a modular toolbox and supports two primary research pipelines, enabling a complete workflow from algorithm evaluation to the development of new learning-based models.

<div align="center">

🗃️ [Model](pyjnd/models.md)  |  📦 [Dataset](datasets/prepare_datasets.md)  | 🛠️ [Codec](codecs/prepare_codecs.md) | 📈[Benchmark](results/results.md)
...
For detailed instructions on encoder installation, configuration, and usage, please refer to [`codecs/prepare_codecs.md`](codecs/prepare_codecs.md).  
...
<p align="center">
  <img src="assets/training_pipeline.svg" width="900">
</p>

Our training pipeline supervises the lightweight CNN with a hybrid loss function. The spatial-domain component compares the network's filtered output against a Ground Truth (GT) generated by a reference "teacher" filter. The frequency-domain component enforces two key constraints: a residual loss against the GT to learn its behavior, and our novel conservation loss against the original input to surpass it.
...
datasets:
  train:
    ...
    dataroot_ref: ./datasets/divkon_2k_yuv/tip_bae_2016_filter_4
...
This work is licensed under a [FDU Vip-Lab License](./LICENSE-FDU-Vip-Lab.txt) and <a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/">Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License</a>.
...
The VIP Lab at Fudan University **Lab Website:** [http://viplab.fudan.edu.cn](http://viplab.fudan.edu.cn)
