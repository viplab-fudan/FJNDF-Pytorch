...
# spatial-domain JND effect base model
...
class SpatialEffectBase(torch.nn.Module):
    """
    Spatial-domain JND effect base class, all specific models should inherit and implement predict()
    """
...
def register_spatial_effect(effect_type: str, model_name: str = None):
    """Decorator: Mark a subclass and automatically write to _SPATIAL_EFFECT_REGISTRIES."""
    def _decorator(cls):
