...
from pyjnd import get_dataset_info
from pyjnd.data import build_dataset
from typing import Optional, Dict, Any


dataset_download_name = {
    'konjnd_1k': 'konjnd_1k.tgz',
    'cpl_set': 'cpl_set.tgz',
    'raise': 'raise.tgz',
    'jpeg_aic3': 'jpeg_aic3.tgz',
    'mcl_jci': 'mcl_jci.tgz',
    'mcl_jcv': 'mcl_jcv.tgz',
    'videoset': 'videoset.tgz',
}
...
def load_dataset(
    ...
    **kwargs: Any
    ...
    dataset_info['dataroot_in'] = data_root / Path(
        *Path(dataset_info['dataroot_in']).parts[1:]
    )
    ...
    if force_download or not osp.exists(dataset_info['dataroot_in']):
